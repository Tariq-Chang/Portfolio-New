...
const About = () => {
  return (
    <div className=" w-full py-2 md:flex items-center md:py-16 px-12">
      <div className="w-60 h-60 mx-auto px-4 py-6 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-100 h-100">
        <img
          src={`${vectorIcon}`}
      ...
      <div className="w-full mx-auto px-2 py-8 drop-shadow-lg text-[#333] max-w-[350px] text-justify sm:max-w-[400px]">
        <h1 className="py-2 text-center text-xl font-semibold tracking-wider sm:text-2xl sm:font-bold md:text-3xl">
          About
        </h1>
